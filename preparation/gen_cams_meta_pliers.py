...
import trimesh
import sys
sys.path.append("/home/jiang/code/CAMS-main")
from data.mano_assets.manotorch.manolayer import ManoLayer
...
manolayer = ManoLayer(
    mano_assets_root='/home/jiang/code/CAMS-main/data/mano_assets/mano/',
    side='right'
)
...
# all in obj frame
mano_parts = torch.load('/home/jiang/code/CAMS-main/data/preparation/mano_parts_1.pt')

meta_file = '/home/jiang/code/CAMS-main/data/meta/pliers_meta.torch'
