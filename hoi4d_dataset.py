...
class HOI4D(Dataset):
    ...
    def __init__(self, data_config, phase: str, slurm: bool, case_only: bool=False):
    ...
    def prepare_data(self, idx):
        ...
        for part in range(self.n_parts):
            ...
            sample_index = random.sample(range(1, init_pts_num), k=self.config.sample_num)
        ...
        data = {
            'obj_vertices': obj_vertices,  #2,1000,3
